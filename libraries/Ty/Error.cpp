...
Error Error::from_leaky_string(StringView message, c_string function, c_string file, u16 line, u16 col)
{
    return Error::from_string_literal(MUST(StringBuffer::create_saturated_fill(message, "\0"sv)).leak(), function, file, line, col);
}
